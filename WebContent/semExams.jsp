...
<body>
	...
	<div align="center">
		<table class="tbl">
			<thead align="left">
				<tr>
					<td  colspan="3"><center><strong>List of
							Semester Examination</strong></center></td>
				</tr>
			...
			<tbody >
				...
				<tr>
					<td><%=i%></td>
					<td><a href="#"
						onclick="searchUser(<%=rs.getInt("exam_id")%>,<%=designationid%>)"><%=rs.getString(2)%></a></td>
				</tr>
				<%} %>
			</tbody>
		</table>
