...
/**
 * Servlet implementation class PayUserSearch
 */
@WebServlet("/PayUserSearch")
public class PayUserSearch extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PayUserSearch() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userCount>0)
		{
			...
			{
			alert="Valid User";
			RequestDispatcher rd=request.getRequestDispatcher("feesConfiguration.jsp?userid="+userId+"& examid=" + examid+"&designationId="+designationID+"&alert="+alert);
			...
			{
				alert="Invalid User";
				RequestDispatcher rdp=request.getRequestDispatcher("feesConfiguration.jsp?userid="+userId+"& examid=" + examid+"&designationId="+designationID+"&alert="+alert);
			...
			RequestDispatcher rd1=request.getRequestDispatcher("feesConfiguration.jsp?userid="+userId+"& examid=" + examid+"&designationId="+designationID+"&alert="+alert);
